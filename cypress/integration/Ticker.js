...
tickerText()
{
    ...
    cy.xpath(getvalue.tickerTextXpath).should('include.text',getvalue.tickerText).should('have.css','background-color',getvalue.tickerBackgroundColor).should('have.css','color',getvalue.tickerColor)
